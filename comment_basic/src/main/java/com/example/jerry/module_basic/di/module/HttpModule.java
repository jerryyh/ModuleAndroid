...
import com.example.jerry.module_basic.constants.Constants;
import com.example.jerry.module_basic.net.ApiService;
import com.example.jerry.module_basic.net.WanAndroidUrl;
import com.example.jerry.module_basic.net.cookies.CookiesManager;
import com.example.jerry.module_basic.util.CommonUtils;
...
public class HttpModule {
    ...
    @Singleton
    @Provides
    ApiService provideGeeksApi(@WanAndroidUrl Retrofit retrofit) {
