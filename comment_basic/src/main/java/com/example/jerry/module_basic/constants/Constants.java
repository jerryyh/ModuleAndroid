package com.example.jerry.module_basic.constants;
...
public class Constants {
     ...
     * Path
     */
    public static final String PATH_DATA = BaseApplication.getAppContext().getCacheDir().getAbsolutePath() + File.separator + "data";
