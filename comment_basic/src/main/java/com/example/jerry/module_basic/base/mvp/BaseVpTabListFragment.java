...
import com.example.jerry.module_basic.R2;
...
import com.example.jerry.module_basic.bean.TabListBean;
...
public abstract class BaseVpTabListFragment<V extends IView,P extends IPresenter<V>> extends BaseMvpFragment<V, P> implements View.OnClickListener {
