...
public class ServiceHelper {
    ...
    private static SparseArray<ServiceHelper> sRetrofitManager = new SparseArray<>(HostType.TYPE_COUNT);
...
/*
   1. noCache 不使用缓存，全部走网络
     ...
     * @param hostType
     */
    private ServiceHelper(int hostType) {
    ...
    public static Retrofit getDefault(int hostType) {
        ServiceHelper retrofitManager = sRetrofitManager.get(hostType);
        if (retrofitManager == null) {
            retrofitManager = new ServiceHelper(hostType);
