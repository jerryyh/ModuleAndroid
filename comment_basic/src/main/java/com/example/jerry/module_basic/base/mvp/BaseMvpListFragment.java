...
public abstract class BaseMvpListFragment<V extends IView,P extends IPresenter<V>> extends BaseMvpFragment<V, P> implements OnRefreshListener, OnLoadMoreListener {
