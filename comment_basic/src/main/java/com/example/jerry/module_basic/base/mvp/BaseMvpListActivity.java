...
public abstract class BaseMvpListActivity<V extends IView, P extends IPresenter<V>> extends BaseMvpActivity<V ,P> implements OnRefreshListener, OnLoadMoreListener {
